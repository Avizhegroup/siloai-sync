...
public class PersianCalendarTools
{
    ...
    public static string GetLastDayOfMonth(DateTime dateTime)
    {
        string persianDate = GregorianToPersian(dateTime);
    ...
    public static string GetFirstDayOfMonth(DateTime dateTime)
    {
        string persianDate = GregorianToPersian(dateTime);
